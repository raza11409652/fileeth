...
contract Patient {
  ...
  event RecordCreated(
    ...
    function insertProblem(string memory _problem , string memory _suggestion ,  uint _user  , address _sender , string memory  _doctor) public {
      problemCount ++ ;
      problem[problemCount] = Problem(problemCount , _problem ,_suggestion ,  _user , _sender , _doctor );
    }
